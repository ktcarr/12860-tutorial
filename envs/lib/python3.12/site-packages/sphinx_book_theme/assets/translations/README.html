...
<html lang="en" data-content_root="../../../../../../../" >
  ...
  <head>
    ...
    <title>Translation workflow &#8212; My sample book</title>
...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=dfe6caa3a7d634c4db9b" />
  <script src="../../../../../../../_static/vendor/fontawesome/6.5.2/js/all.min.js?digest=dfe6caa3a7d634c4db9b"></script>
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = 'envs/lib/python3.12/site-packages/sphinx_book_theme/assets/translations/README';</script>
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/executablebooks/jupyter-book/issues/new?title=Issue%20on%20page%20%2Fenvs/lib/python3.12/site-packages/sphinx_book_theme/assets/translations/README.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/envs/lib/python3.12/site-packages/sphinx_book_theme/assets/translations/README.md" target="_blank"
...
Finally, run <code class="docutils literal notranslate"><span class="pre">python</span> <span class="pre">src/sphinx_book_theme/_compile_translations.py</span></code> and this will update the <code class="docutils literal notranslate"><span class="pre">.mo</span></code> files.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./envs/lib/python3.12/site-packages/sphinx_book_theme/assets/translations"
        },
